...
Tourism income (EUR) & 2016: 8.145 M & 2020: 6.106 M & 2022: 13.638 M \\
\bottomrule
\end{tabular}
\end{table}

Between 2016 and 2019, tourism income in Peniche grew by about 53\%, then fell by roughly 51\% in 2020, before recovering to a level about 9\% above 2019 by 2022. Over the same period, average income per guest increased from approximately EUR~94.0 to EUR~124.2, and average income per overnight stay rose from roughly EUR~45.8 to EUR~57.2. Even without claiming that Ericeira and Peniche are identical, these figures are enough to justify a model in which surf-tourism actors perceive meaningful losses if offshore interventions degrade the conditions that attract surfers and associated visitors.

\input{Game theoretic Model}
